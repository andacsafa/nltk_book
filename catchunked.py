from nltk.corpus.reader import ChunkedCorpusReader, CategorizedCorpusReader
...
class CategorizedChunkedCorpusReader(CategorizedCorpusReader,
    ...
    def sents(self, fileids=None, categories=None):
        return ChunkedCorpusReader.sents(self,self_resolve(fileids,
            categories))

    def paras(self, fileids=None, categories=None):
        return ChunkedCorpusReader.paras(self,self_resolve(fileids,
            categories))

    def tagged_words(self, fileids=None, categories=None):
        return ChunkedCorpusReader.tagged_words(self,self_resolve(fileids,
            categories))
    ...
    def tagged_paras(self, fileids=None, categories=None):
        return ChunkedCorpusReader.tagged_paras(self,self_resolve(fileids,
            categories))
